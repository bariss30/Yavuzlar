...
$currentQuestion = !empty($questions) ? $questions[0] : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['answer'])) {
        ...
        if ($selectedAnswer == $correctAnswer) {
            ...
            $updateScoreStmt = $conn->prepare("UPDATE member SET score = score + 10 WHERE username = :username");
            $updateScoreStmt->execute(['username' => $username]);
        } else {
...
<body>
    <div class="app">
        ...
        <button class="score-button" onclick="window.location.href='score.php';">Puanları Göster</button>
        <h1>Quiz</h1>
        <div class="quiz">
